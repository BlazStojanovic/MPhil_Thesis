...
% Crest minimum should be 30mm.
%\collegeshield{\includegraphics[width=0.3\textwidth]{Figs/CollegeShields/StJohns.png}}
...
%% Meta information
\subject{LaTeX} \keywords{{LaTeX} {MPhil Thesis} {Scientific Computing} {University of
Cambridge}}
