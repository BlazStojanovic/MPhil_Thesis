...
\chapter{Methodology}
\label{chapter5}
This chapter presents the computational method developed in this thesis. We start by introducing each component of the method separately before presenting how they fit together into a single procedure. We discuss importance sampling, automatic differentiation, gradient estimation, as well as, gradient-based optimisation. Finally, we present the actual implementation in \emph{JAX}, and discuss computational considerations and intricacies of thereof.
...
\subsection{Connection between to Score-Based models}